...
button.on('click', function(e) {
	...
	var input = $('#libros');
	var findBook = input.val();
	var getbookUrl = "https://www.googleapis.com/books/v1/volumes?q=" + findBook
	...
	$.ajax({
		...
		success: function( dataRecieved ) { 
			...
			var bookInfo = dataRecieved;			

			var newBookInfo = bookInfo.items

			for (var i = 0; i < newBookInfo.length; i++) {

				var newArray = newBookInfo[i]
